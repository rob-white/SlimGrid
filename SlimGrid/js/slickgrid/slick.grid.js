...
(function ($) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function createCssRules() {
        //$style = $(".slickgrid-stylesheet");
        //if ($('.slickgrid-stylesheet').length == 0) {
            $style = $("<style class='slickgrid-stylesheet' type='text/css' rel='stylesheet' />").appendTo($("head"));
        //}
    ...
    function getColumnCssRules(idx) {
      if (!stylesheet) {
        ...
        for (var i = 0; i < cssRules.length; i++) {
            ...
            //var reg1 = new RegExp('\.' + uid + ' (\.l\\d+)');
            //var reg2 = new RegExp('\.' + uid + ' (\.r\\d+)');
